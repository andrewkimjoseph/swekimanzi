...
const PILLARS = [
  ...
  },
  {
    ...
    body: "Kenyan open-source tech hub — Build. Burn. Evolve. Organized Wajenzi Hack 1.0, runs community programs, and ships tools like a Paystack + M-Pesa merch shop. 500+ active members.",
...
function HomePage() {
  ...
  return (
    <div className="py-8 flex flex-col gap-16">
      {/* HERO */}
      <section className="grid md:grid-cols-[200px_1fr] gap-6 items-center">
        <motion.div
          initial={reduce ? false : { scale: 0.9, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
          transition={{ delay: 0.2, duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
          className="max-w-[220px] mx-auto md:mx-0 w-full"
        >
          <AvatarPlaceholder />
        </motion.div>
